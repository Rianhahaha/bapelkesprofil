...
class __TwigTemplate_5caa98d7edb493dd86f2870196a06523 extends Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-tips__item--id-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 50), 50, $this->source)))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/claro/templates/filter/filter-tips.html.twig", "F:\\laragon\\www\\bapelkes_ORI_COBA1\\core\\themes\\claro\\templates\\filter\\filter-tips.html.twig");
    }
