...
class ModalForm extends EntityForm {
   ...
   */
  public function __construct(LanguageManagerInterface $language_manager, ConfigFactoryInterface $config_factory, RendererInterface $renderer, ModalPageService $modalPageService, ExtensionPathResolver $extension_path_resolver = NULL, ModalFieldValidationService $modal_field_validations) {
